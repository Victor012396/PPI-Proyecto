                        ...
                        <form method='POST' action="{{ route('producto.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="text" name="marca" class="form-control border border-2 p-2">
                                    @error('marca')
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="text" name="tipo" class="form-control border border-2 p-2" >
                                    @error('tipo')
                                <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                                </div>
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="number" name="costo" class="form-control border border-2 p-2">
                                    @error('costo')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                </div>
